...
const servicesEngineering = [
  {
    ...
    tagline:
      "We work closely with project teams to develop structures that respond to both technical requirements and practical execution considerations.",
    desc: "Our structural engineering services provide clear, efficient structural systems that balance strength, constructability, and long-term performance.",
    features: [
  ...
  },
  {
    ...
    desc: "Our mechanical engineering services focus on creating systems that perform efficiently, reliably, and consistently over time.",
    features: [
  ...
  },
  {
    ...
    icon: <Zap size={24} />,
    tagline:
      "We focus on clarity, compliance, and scalability — ensuring electrical systems meet current demands while allowing for future growth and operational flexibility.",
    desc: "Our electrical engineering services are designed to deliver safe, resilient, and adaptable power systems for complex environments.",
    features: [
